 ...
 */
// диаграммы,
// в сервисном слое не должно быть обращения на слой выше, не должно быть SQLException
// выбрать  паттерн, которые сгласовывается с реалзованным
// исправить ошибки (эксепшины, список с 10 раза)
// добавить в бизнес-логику контроль состояний заказа и контроль тех данных, которые могут или не могут редактировать те или иные роли
